...
try:
    ...
    la=Label(back,text='Placements',width=20,padx=10,pady=10,bd=5,bg='silver')
    ...
    for row in t:
        ...
        bta=Button(back,text='Update',width=10,bd=5,font='times 10')
        bta.config(command=lambda cid=row[15]:student_view(cid))
